...
public class BaseAction<T> {
	...
	public void listByPage(){
		...
		//把部门列表转JSON字符串 DisableCircularReferenceDetect=>禁止循环引用保护
		//WithDateFormat 加上日期格式，自动把日期转成字符串的格式
	...
	public String mapData(String jsonString, String prefix){
		...
		//给每key值加上前缀
		/*
		前：t.dep:{name: "管理员组", tele: "000000", uuid: 1}
		后:"t.dep.name":"管理员组","t.dep.tele":"000000","t.dep.uuid":1
		*/
